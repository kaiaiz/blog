...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_59eedd3cc845b3_52157086',
...
function content_59eedd3cc845b3_52157086 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/project/blog/static/index/css/index.css">
  <link rel="stylesheet" href="http://localhost/project/blog/static/index/iconfont/iconfont.css">
  <link rel="stylesheet" href="http://localhost/project/blog/static/index/css/swiper.min.css">
  <style>
    body {
      background: #eee;
    ...
    .pc-banner {
      background: url(http://localhost/project/blog/static/index/img//top_main_bg01.jpg) no-repeat center top/100% auto;
      width: 100%;
      float: left;
    }
    ...
    @media screen and (min-width: 668px) {
      .swiper-slide a:after {
        ...
        width: 100%;
        height: 100%;
        background: url(http://localhost/project/blog/static/index/img/top_slick_cover_bg01.png) 0 0 repeat;
        border-radius: 20px;
      }
    }
...
<body>
  ...
  <header class="top">
    <main class="content">
      <a href="" class="left">
        <img src="http://localhost/project/blog/static/index/img/logo.png" height="40px" alt="">
      </a>
      <ul class="caption">
        <li>
    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <a href="#">
            <img src="http://localhost/project/blog/static/index/img/top_hero_cs_2017.jpg">
          </a>
        </div>
        <div class="swiper-slide">
          <a href="#">
            <img src="http://localhost/project/blog/static/index/img/top_hero_cw_im17.jpg">
          </a>
        </div>
        <div class="swiper-slide">
          <a href="#">
            <img src="http://localhost/project/blog/static/index/img/top_hero_hakko.jpg">
          </a>
        </div>
        <div class="swiper-slide">
          <a href="#">
            <img src="http://localhost/project/blog/static/index/img/top_hero_karadacalpis_im02.jpg">
          </a>
        </div>
      </div>
    </div>
  ...
  <!-- Swiper JS -->
  <script src="http://localhost/project/blog/static/index/js/swiper.min.js"></script>
      ...
      <div class="left">
        <ul>
          <li>
            ...
            <div class="article">
              <a href="">
                <img src="http://localhost/project/blog/static/index/img/article01.png" width="100%" height="100%" alt="">
              </a>
              <p class="remark">
